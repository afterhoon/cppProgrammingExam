/*
	BankingSystemVer02를 복사생성자를 통해 업그레이드
	(https://github.com/afterhoon/cppProgrammingExam/blob/master/Chapter04/04-Project(BankingSystemVer02).cpp)
*/
...
public:
	...
	Account(Account &copy) : accID(copy.accID), money(copy.money) {
